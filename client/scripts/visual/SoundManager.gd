...
func _ready() -> void:
	...
	for cue in ["ui", "card_select", "card_fly", "card_land", "dice_throw", "collision_small", "collision_medium", "collision_big", "walk", "jump", "land", "stack", "squash", "coin_gain", "coin_loss", "turn", "round", "game"]:
...
func _synthesize(cue: String) -> AudioStreamWAV:
	var settings: Array = ({
		...
		"coin_gain": [1040.0, 0.12, 0.24], "coin_loss": [210.0, 0.13, 0.4], "turn": [780.0, 0.16, 0.25], "round": [620.0, 0.28, 0.28], "game": [880.0, 0.42, 0.3],
