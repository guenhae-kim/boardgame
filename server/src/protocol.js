...
export const MessageType = Object.freeze({
  ...
  PLAYER_TAKEOVER: "PLAYER_TAKEOVER",
  ...
  GAME_TIMEOUT_REQUEST: "GAME_TIMEOUT_REQUEST",
  CHAT_SEND: "CHAT_SEND",
...
const CLIENT_MESSAGE_TYPES = new Set([
  ...
  MessageType.JOIN_SPECTATOR,
  MessageType.RECONNECT,
  MessageType.SESSION_CHECK,
  MessageType.LEAVE_ROOM,
  MessageType.LEAVE_SESSION,
  MessageType.UPDATE_NICKNAME,
